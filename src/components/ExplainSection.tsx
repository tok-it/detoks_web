...
const items = [
  ...
  },
  {
    icon: Workflow,
    title: "흐름을 보여줍니다",
    description: "어떤 일을 먼저 하고 다음에 무엇을 할지 확인하기 쉽게 만듭니다.",
  },
  {
    icon: Bot,
    title: "에이전트에게 전달합니다",
    description: "AI 코딩 에이전트가 더 명확한 흐름으로 작업할 수 있게 돕습니다.",
  },
];

export function ExplainSection() {
  return (
    <section id="about" className="flex h-screen items-center overflow-hidden px-5 md:px-8">
      <div className="mx-auto w-full max-w-7xl">
            ...
            return (
              ...
              >
                <LiquidCard className="h-full p-6">
                  <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-2xl border border-[#00c853]/25 bg-[#00c853]/10 text-[#00c853]">
        ...
        <LiquidCard className="mt-5 p-5">
          <div className="flex flex-col items-center justify-center gap-4 text-center md:flex-row">
            <span className="rounded-full border border-white/10 bg-white/[0.06] px-5 py-2.5 font-black">
              User Prompt
            </span>
            <ArrowRight className="h-5 w-5 text-[#00c853]" />
            <span className="rounded-full border border-[#00c853]/30 bg-[#00c853]/10 px-5 py-2.5 font-black text-[#00c853]">
              DeToks
            </span>
            <ArrowRight className="h-5 w-5 text-[#00c853]" />
            <span className="rounded-full border border-white/10 bg-white/[0.06] px-5 py-2.5 font-black">
