...
export function ExampleSection() {
  return (
    <section id="example" className="relative px-5 py-24 md:px-8">
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          ...
          >
            <LiquidCard className="h-full p-7 md:p-8">
              <p className="mb-4 text-sm font-black uppercase tracking-[0.18em] text-white/45">
                Before
              </p>
              <p className="text-2xl font-black leading-10 tracking-[-0.035em]">
          ...
          >
            <LiquidCard className="h-full border-[#00c853]/35 p-7 md:p-8">
              <p className="mb-4 text-sm font-black uppercase tracking-[0.18em] text-[#00c853]">
                After
              </p>
